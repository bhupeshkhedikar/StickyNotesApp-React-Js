          ...
          <Grid item xs={12} sm={6} md={4} lg={3}>
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" component="div"> Status: {event.status}</Typography>
                <Typography variant="body2" component="div"> Organizer: {event.organizer.email}</Typography>
                <Typography variant="body2" component="div"> Organizer: {event.start.dateTime}</Typography>
              </CardContent>
            </Card>
          </Grid>
        ))}
